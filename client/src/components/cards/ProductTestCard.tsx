...
const ProductTestCard = ({ product, index }: IProps) => {
  ...
  return (
    <ProductCardContainer slug={product.slug}>
      <div
        className={`md:p-3 p-2 bg-white shadow-xl relative  overflow-hidden hover:cursor-pointer product-card ${index !== undefined && (index + 1) % 2 === 0 ? " md:mt-0 " : ""} h-full`}
      >
        ...
        <div className="mt-2 space-y-2  ">
          ...
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              ...
              <p className="text-gray-400 text-sm">({product.rating})</p>
            </div>
            {pricing.offerPrice ? (
