  ...
  return (
    <>
      <div
        ...
        className="p-2  border-2 border-gray-900/10 rounded-md flex items-center text-center justify-center flex-col  min-h-20"
      >
      ...
      {isOpen ? (
        ...
        >
          ...
          <button
            onClick={() => setIsOpen(false)}
            className="text-2xl text-white absolute top-2 right-2 p-2 border-2 rounded-full lg:hidden "
          >
            <RxCross2 />
          </button>
        </div>
