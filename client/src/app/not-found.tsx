    ...
    <div className="w-full  h-screen flex flex-col gap-2  justify-center items-center">
      ...
      <div className="mt-5 space-y-2">
        ...
        <p className="text-gray-700 w-10/12 text-center mx-auto text-sm">
          The page you’re looking for doesn’t exist or has been moved. It might be due to a broken
          link or incorrect URL. Please check the address or return to the homepage to continue
          browsing.
        </p>
      </div>
      <div className="mt-4 flex md:flex-row flex-col md:items-center  justify-center gap-3  ">
        <button
          onClick={() => router.back()}
          className="px-7 py-3 hover:bg-primary hover:text-white border-2 border-gray-700/20 rounded-md md:w-fit w-full"
        >
          Go Back
        </button>
