...
const getAllOverviewDataFromDB = () => __awaiter(void 0, void 0, void 0, function* () {
...
const getUsersOverviewFromDB = () => __awaiter(void 0, void 0, void 0, function* () {
    const userWhereConditions = {
        status: {
            not: client_1.UserStatus.DELETED,
        },
...
const getOrdersOverviewFromDB = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const totalPlaced = ((_a = group.find((_) => _.status === client_1.OrderStatus.PLACED)) === null || _a === void 0 ? void 0 : _a._count) || 0;
    const totalProcessing = ((_b = group.find((_) => _.status === client_1.OrderStatus.PROCESSING)) === null || _b === void 0 ? void 0 : _b._count) || 0;
    const totalInTransit = ((_c = group.find((_) => _.status === client_1.OrderStatus.IN_TRANSIT)) === null || _c === void 0 ? void 0 : _c._count) || 0;
    const totalDelivered = ((_d = group.find((_) => _.status === client_1.OrderStatus.DELIVERED)) === null || _d === void 0 ? void 0 : _d._count) || 0;
    const totalFailed = ((_e = group.find((_) => _.status === client_1.OrderStatus.FAILED)) === null || _e === void 0 ? void 0 : _e._count) || 0;
    const totalCanceled = ((_f = group.find((_) => _.status === client_1.OrderStatus.CANCELED)) === null || _f === void 0 ? void 0 : _f._count) || 0;
    const totalReturned = ((_g = group.find((_) => _.status === client_1.OrderStatus.RETURNED)) === null || _g === void 0 ? void 0 : _g._count) || 0;
    return {
        total,
        totalPlaced,
        totalProcessing,
...
const getProductsOverviewFromDB = () => __awaiter(void 0, void 0, void 0, function* () {
...
const getDiscountOverviewFromDB = () => __awaiter(void 0, void 0, void 0, function* () {
...
const getPaymentsOverviewFromDB = () => __awaiter(void 0, void 0, void 0, function* () {
...
const getMyOverviewDataFromDB = (authUser) => __awaiter(void 0, void 0, void 0, function* () {
    const ordersTotal = yield prisma_1.default.order.count({
        where: {
            ...
            OR: [
                ...
                },
                {
                    payment: {
                        method: {
                            not: client_1.PaymentMethod.COD,
                        },
                    },
                    paymentStatus: "PAID",
                },
            ...
            status: {
                notIn: [client_1.OrderStatus.PENDING, client_1.OrderStatus.CANCELED],
            },
        },
    });
    const notReviewedTotal = yield prisma_1.default.orderItem.count({
        where: {
            order: {
                customerId: authUser.customerId,
    ...
    const unreadNotificationsTotal = yield prisma_1.default.notification.count({
        where: {
            userId: authUser.id,
            isRead: false,
        },
    });
    const reviewsTotal = yield prisma_1.default.productReview.count({
        where: {
            customerId: authUser.customerId,
        },
    });
