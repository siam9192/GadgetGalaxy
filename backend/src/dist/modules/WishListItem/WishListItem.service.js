...
const createWishListItemIntoDB = (authUser, payload) => __awaiter(void 0, void 0, void 0, function* () {
...
const deleteWishListItemFromDB = (authUser, productId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!item)
        throw new AppError_1.default(http_status_1.default.NOT_FOUND, "Product not found in wishlist");
...
const getWishListItemsFromDB = (authUser, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    const { page, limit, skip } = (0, paginationHelper_1.calculatePagination)(paginationOptions);
