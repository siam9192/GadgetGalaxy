...
const createReviewIntoDB = (authUser, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!orderItem) {
        throw new AppError_1.default(http_status_1.default.NOT_FOUND, "Order item not found");
    }
...
const createReviewResponseIntoDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
...
const getMyNotReviewedProductsFromDB = (authUser, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const totalResult = yield prisma_1.default.orderItem.count({
        where: whereConditions,
    });
    return {
        data: data,
...
const getProductReviewsFromDB = (productId, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    productId = Number(productId);
    const { skip, limit, page, orderBy, sortOrder } = (0, paginationHelper_1.calculatePagination)(paginationOptions);
    const whereConditions = {
        id: productId,
        status: client_1.ProductReviewStatus.VISIBLE,
    };
    const reviews = yield prisma_1.default.productReview.findMany({
        where: whereConditions,
        take: limit,
        skip,
        orderBy: {
    ...
    const totalResult = yield prisma_1.default.productReview.count({
        where: whereConditions,
    });
...
const getMyReviewsFromDB = (authUser, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    const { skip, limit, page, orderBy, sortOrder } = (0, paginationHelper_1.calculatePagination)(paginationOptions);
    const whereConditions = {
        customerId: authUser.customerId,
    };
...
const updateReviewIntoDB = (authUser, id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    id = Number(id);
...
const changeReviewStatusIntoDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const review = yield prisma_1.default.productReview.findUnique({
        where: {
            id: payload.id,
        },
