...
const ChangeUserStatusIntoDB = (authUser, payload) => __awaiter(void 0, void 0, void 0, function* () {
...
const getCustomersFromDB = (filterQuery, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (searchTerm && !(0, function_1.isNumber)(searchTerm)) {
        andConditions.push({
...
const getAdministratorsFromDB = (filterQuery, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
...
const softDeleteUserByIdIntoDB = (authUser, id) => __awaiter(void 0, void 0, void 0, function* () {
    id = Number(id);
...
const createAdministratorIntoDB = (authUser, payload) => __awaiter(void 0, void 0, void 0, function* () {
