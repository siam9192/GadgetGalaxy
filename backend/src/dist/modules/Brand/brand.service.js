...
const createBrandIntoDB = (authUser, payload) =>
...
const getBrandsFromDB = (filter, paginationOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const andConditions = [];
...
const getBrandsForManageFromDB = (filter, paginationOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const andConditions = [];
    const { searchTerm, origin } = filter;
...
const getPopularBrandsFromDB = (paginationOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getFeaturedBrandsFromDB = (paginationOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { skip, limit, page } = (0, paginationHelper_1.calculatePagination)(
      paginationOptions,
    );
...
const updateBrandIntoDB = (authUser, id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    id = Number(id);
    const brand = yield prisma_1.default.brand.findUnique({
      where: {
...
const getSearchRelatedBrandsFromDB = (filterQuery) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getCategoryRelatedBrandsFromDB = (slug) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getSearchKeywordBrandsFromDB = (keyword) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const brands = yield prisma_1.default.brand.findMany({
      where: {
        name: {
