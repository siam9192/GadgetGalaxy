...
const createProductIntoDB = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    let counter = 1;
    while (
      yield prisma_1.default.product.findUnique({
        where: { slug },
        select: { id: true },
      })
    ) {
    ...
    const productData = {
      ...
      discountPercentage: (0, function_1.calculateDiscountPercentage)(
        payload.price,
        payload.offerPrice,
      ),
      ...
      __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (variants && variants.length) {
          for (let i = 0; i < variants.length; i++) {
            const _a = variants[i],
              { attributes } = _a,
              variant = __rest(_a, ["attributes"]);
            // Insert variant fist after insert variant attributes
            const createdVariant = yield txClient.variant.create({
              data: Object.assign(
                Object.assign({ productId: createdProductData.id }, variant),
                {
                  discountPercentage: (0,
                  function_1.calculateDiscountPercentage)(
                    variant.price,
                    variant.offerPrice,
                  ),
            ...
            yield txClient.variantAttribute.createMany({
              data: attributes.map((_) =>
                Object.assign({ variantId: createdVariant.id }, _),
              ),
            });
          }
        }
    ...
    if (variants) {
      if (
        variants === null || variants === void 0
          ? void 0
          : variants.filter((_) => !_.isDeleted).length
      ) {
        // Check price
        variants
        ...
        if (specifications && specifications.length) {
          ...
          yield txClient.productSpecification.createMany({
            data: specifications.map((spec) =>
              Object.assign({ productId: id }, spec),
            ),
          });
        }
        if (variants && variants.length) {
          ...
          const newAddedVariants = variants.filter(
            (_) => !_.id && !_.isDeleted,
          );
          // Insert new added variants
          if (newAddedVariants.length) {
            for (const variant of newAddedVariants) {
              const { attributes, isDeleted, id: varId } = variant,
                others = __rest(variant, ["attributes", "isDeleted", "id"]);
              // Insert variant
              const createdVariant = yield txClient.variant.create({
                data: Object.assign(Object.assign({ productId: id }, others), {
                  discountPercentage: (0,
                  function_1.calculateDiscountPercentage)(
                    others.price,
                    others.offerPrice,
              ...
              yield txClient.variantAttribute.createMany({
                data: attributes.map((att) =>
                  Object.assign({ variantId: createdVariant.id }, att),
                ),
              });
            }
          }
          ...
          if (updatedVariants.length) {
            for (const variant of updatedVariants) {
              const { id, isDeleted, attributes } = variant,
                other = __rest(variant, ["id", "isDeleted", "attributes"]);
...
const getRecentlyViewedProductsFromDB = (authUser, ids) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getSearchProductsFromDB = (filterQuery, paginationOptions, authUser) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { page, limit, skip, orderBy, sortOrder } = (0,
    ...
    const data = products.map((product) => {
      ...
      const upd = Object.assign(Object.assign({}, product), {
...
const getProductsForManageFromDB = (filterData, paginationOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getRelatedProductsByProductSlugFromDB = (productSlug, authUser) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const product = yield prisma_1.default.product.findUnique({
      where: {
        slug: productSlug,
...
const getProductBySlugForCustomerViewFromDB = (authUser, slug) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const product = yield prisma_1.default.product.findUnique({
      where: {
        slug,
...
const getFeaturedProductsFromDB = (paginationOptions, authUser) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { page, skip, limit, sortOrder, orderBy } = (0,
    paginationHelper_1.calculatePagination)(paginationOptions);
    const products = yield prisma_1.default.product.findMany({
      where: {
        isFeatured: true,
...
const getNewArrivalProductsFromDB = (paginationOptions, authUser) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { page, skip, limit, sortOrder, orderBy } = (0,
    paginationHelper_1.calculatePagination)(paginationOptions);
    const whereConditions = {
...
const getStockOutProductsFromDB = (paginationOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { page, limit, skip, sortOrder, orderBy } = (0,
    paginationHelper_1.calculatePagination)(paginationOptions);
    const whereConditions = {
      OR: [
        {
...
const getCategoryProductsFromDB = (
  slug,
  filterQuery,
  paginationOptions,
  authUser,
...
const softDeleteProductFromDB = (id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    id = Number(id);
    const product = yield prisma_1.default.product.findUnique({
      where: {
...
const updateProductStockIntoDB = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const transaction = yield prisma_1.default.$transaction((tx) =>
      __awaiter(void 0, void 0, void 0, function* () {
