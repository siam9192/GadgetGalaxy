...
const createDiscountIntoDB = (authUser, payload) =>
...
const updateDiscountIntoDB = (authUser, id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    id = Number(id);
    const discount = yield prisma_1.default.discount.findUnique({
      where: {
    ...
    const { new: newI, removed } = payload,
      othersData = __rest(payload, ["new", "removed"]);
    ...
    const result = yield prisma_1.default.$transaction((txClient) =>
      __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (payload.removed) {
          const {
            categoriesId: removedCategories,
            customersId: removedCustomers,
          } = payload.removed;
...
const getDiscountsFromDB = (filter, paginationOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getDiscountsForManageFromDB = (filter, paginationOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { code, startDate, endDate, validFrom, validUntil, status } = filter;
    const andConditions = [];
    if (code) {
...
const changeDiscountStatusIntoDB = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const applyDiscount = (authUser, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
