...
const createCategoryIntoDB = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { children, parentId } = payload,
      others = __rest(payload, ["children", "parentId"]);
      ...
      __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (children && children.length) {
          ...
          for (let i = 0; i < children.length; i++) {
            ...
            const data = Object.assign(Object.assign({}, item), {
...
const updateCategoryIntoDB = (id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    id = Number(id);
    const category = yield prisma_1.default.category.findUnique({
      where: {
...
const deleteCategoryByIdFromDB = (id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    id = Number(id);
...
const getCategoriesFromDB = (filterRequest, options) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { searchTerm } = filterRequest,
      othersFilterData = __rest(filterRequest, ["searchTerm"]);
...
const getPopularCategoriesFromDB = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    return yield prisma_1.default
      .$queryRaw`SELECT name,id FROM "categories" ORDER BY RANDOM() LIMIT 6`;
  });
const getFeaturedCategoriesFromDB = () =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getSearchRelatedCategoriesFromDB = (filterQuery) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getAllVisibleCategoriesFromDB = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const data = categories.map((category) => {
      ...
      const item = Object.assign(Object.assign({}, category), { hierarchyStr });
      if (!category.parentId) return item;
    });
    return data;
  });
const getSearchKeywordCategoriesFromDB = (keyword) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const categories = yield prisma_1.default.category.findMany({
      where: {
        name: {
...
const getChildCategoriesBySlugFromDB = (slug) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const categories = yield prisma_1.default.category.findMany({
      where: {
        parent: {
...
const getChildCategoriesByIdFromDB = (id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const categories = yield prisma_1.default.category.findMany({
      where: {
        parent: {
