...
const createCartItemIntoDB = (authUser, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!product)
        ...
        throw new AppError_1.default(http_status_1.default.BAD_REQUEST, "Variant id is required");
    }
    ...
    if (payload.variantId)
        whereConditions.variantId = payload.variantId;
...
const deleteCartItemFromDB = (authUser, id) => __awaiter(void 0, void 0, void 0, function* () {
...
const getMyCartItemsFromDB = (authUser) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = items.map((item) => ({
        id: item.id,
        product: Object.assign(Object.assign({}, item.product), { variant: item.variant }),
        quantity: item.quantity,
    }));
    return result;
});
const changeItemQuantity = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    yield prisma_1.default.cartItem.update({
        where: {
            id: payload.id,
        },
...
const changeItemVariantIntoDB = (authUser, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (yield prisma_1.default.cartItem.findFirst({
        where: {
            customerId: authUser.customerId,
        ...
        throw new AppError_1.default(http_status_1.default.NOT_ACCEPTABLE, "Already exist");
    }
    yield prisma_1.default.cartItem.update({
        where: {
            id: payload.id,
