...
const getMyPayments = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield payment_service_1.default.getMyPaymentsFromDB(req.user, paginationOptions);
    (0, response_1.sendSuccessResponse)(res, {
        statusCode: http_status_1.default.OK,
...
const getPayments = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const paginationOptions = (0, pick_1.default)(req.query, constant_1.paginationOptionKeys);
    const result = yield payment_service_1.default.getPaymentsFromForManageDB(filter, paginationOptions);
    (0, response_1.sendSuccessResponse)(res, {
        statusCode: http_status_1.default.OK,
        message: "Payments retrieved successful",
        data: result,
...
const checkPayment = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield payment_service_1.default.checkPayment(req.query);
