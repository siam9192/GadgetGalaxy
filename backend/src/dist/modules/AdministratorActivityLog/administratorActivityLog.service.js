...
const getActivityLogsFromDB = (filter, paginationOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { administratorId, startDate, endDate } = filter;
    const { skip, limit, page, sortOrder } = (0,
...
const getAdministratorActivities = (id, paginationOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { skip, page, limit, sortOrder, orderBy } = (0,
    paginationHelper_1.calculatePagination)(paginationOptions);
