...
const createShippingChargeIntoDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    return yield prisma_1.default.shippingCharge.create({
        data: payload,
    });
});
const getShippingChargesFromDB = () => __awaiter(void 0, void 0, void 0, function* () {
    return yield prisma_1.default.shippingCharge.findMany();
});
const getShippingChargesForManageFromDB = (filterQuery, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
...
const updateShippingChargeIntoDB = (shippingChargeId, payload) => __awaiter(void 0, void 0, void 0, function* () {
...
const deleteShippingChargeByIdFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    id = Number(id);
    const shippingCharge = yield prisma_1.default.shippingCharge.findUnique({
        where: {
            id,
