...
const node_mailer_service_1 = __importDefault(
  require("../NodeMailer/node-mailer.service"),
);
...
const register = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const emailSendStatus = yield ejs_1.default.renderFile(
      path_1.default.join(
        process.cwd(),
    ...
    const token = jwtHelpers_1.default.generateToken(
      tokenPayload,
      config_1.default.jwt.account_verification_secret,
      "1hr",
    );
    return {
      email: payload.email,
...
const verifyRegistrationUsingOTP = (data) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const decodedToken = yield jwtHelpers_1.default.verifyToken(
      data.token,
      config_1.default.jwt.account_verification_secret,
    );
    ...
    // Match otp
    const isOtpMatched = yield (0, bycrypt_1.bcryptCompare)(
      data.otp,
      verification.otp,
    );
...
const resendOtp = (token) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const verificationData =
      yield prisma_1.default.registrationRequest.findUnique({
        where: {
    ...
    const newToken = jwtHelpers_1.default.generateToken(
      tokenPayload,
      config_1.default.jwt.account_verification_secret,
      "1hr",
    );
...
const googleCallback = (_a) =>
  __awaiter(
    ...
    function* ({ accessToken: googleAccessToken }) {
      ...
      const accessToken = jwtHelpers_1.default.generateToken(
        tokenPayload,
        config_1.default.jwt.access_token_secret,
        "7d",
      );
      // Generating refresh token
      const refreshToken = jwtHelpers_1.default.generateToken(
        tokenPayload,
        config_1.default.jwt.access_token_secret,
...
const login = (res, data) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const accessToken = jwtHelpers_1.default.generateToken(
      tokenPayload,
      config_1.default.jwt.access_token_secret,
      config_1.default.jwt.access_token_expire_time,
    );
    // Generating refresh token
    const refreshToken = jwtHelpers_1.default.generateToken(
      tokenPayload,
      config_1.default.jwt.refresh_token_secret,
      config_1.default.jwt.refresh_token_expire_time,
    );
...
const getAccessTokenUsingRefreshToken = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      // Decode refreshToken
      const decode = jwtHelpers_1.default.verifyToken(
        refreshToken,
        config_1.default.jwt.refresh_token_secret,
      );
...
const changePassword = (authUser, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const forgetPassword = (email) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const token = jwtHelpers_1.default.generateToken(
      ...
      config_1.default.jwt.reset_password_token_expire_time,
    );
    const resetLink = `${config_1.default.origin}/reset-password/${token}`;
    // Send password reset link to email
    yield ejs_1.default.renderFile(
      path_1.default.join(
        process.cwd(),
        "/src/app/templates/reset-password-email.ejs",
      ),
      { link: resetLink },
      function (err, template) {
        return __awaiter(this, void 0, void 0, function* () {
...
const resetPassword = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    let decode;
    try {
      decode = yield jwtHelpers_1.default.verifyToken(
        payload.token,
        config_1.default.jwt.reset_password_token_secret,
      );
      if (!decode) throw new Error();
