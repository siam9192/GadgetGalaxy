...
const payment_service_1 = __importDefault(
...
const initOrderIntoDB = (authUser, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const items = cartItems.map((item) => {
      ...
      return {
        ...
        attributes:
          variant === null || variant === void 0 ? void 0 : variant.attributes,
        quantity,
        price,
    ...
    return yield prisma_1.default.$transaction((txClient) =>
      __awaiter(void 0, void 0, void 0, function* () {
        // **Create Order**
        const createdOrder = yield txClient.order.create({
          data: {
            ...
            notes: payload.notes,
            exceptedDeliveryDate: (0, function_1.convertExceptedDeliveryDate)(
        ...
        yield txClient.orderItem.createMany({
          data: items.map((item) =>
            Object.assign({ orderId: createdOrder.id }, item),
          ),
        });
        ...
        // **Save Shipping Info**
        let _a = payload.shippingInfo,
          { address, addressId } = _a,
          otherShippingInfo = __rest(_a, ["address", "addressId"]);
        if (addressId) {
        ...
        yield txClient.shippingInformation.create({
          data: Object.assign(
            Object.assign({ orderId: createdOrder.id }, otherShippingInfo),
            address,
          ),
        });
        // **Initialize Payment AFTER successful order creation**
        const { paymentId, paymentUrl } =
          yield payment_service_1.default.initPayment({
            method: payload.paymentMethod,
            amount: grossAmount,
            customer: {
              name: payload.shippingInfo.fullName,
              email: payload.shippingInfo.emailAddress,
              phone: payload.shippingInfo.phoneNumber,
            },
            shippingAddress: Object.values(payload.shippingInfo.address).join(
              ",",
            ),
          });
...
const PlaceOrderIntoDB = (authUser, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const cartItems = yield prisma_1.default.cartItem.findMany({
      where: {
        id: { in: payload.cartItemsId },
    ...
    return yield prisma_1.default.$transaction((txClient) =>
      __awaiter(void 0, void 0, void 0, function* () {
        ...
        // **Save Shipping Info**
        let _b = payload.shippingInfo,
          { address, addressId } = _b,
          otherShippingInfo = __rest(_b, ["address", "addressId"]);
        if (addressId) {
          const existingAddress = yield txClient.customerAddress.findUnique({
            where: { id: addressId },
          });
...
const placeOrderAfterSuccessfulPaymentIntoDB = (paymentId, tx) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const manageUnsuccessfulOrdersIntoDB = (status, id, tx) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const updateOrderStatusIntoDB = (authUser, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield prisma_1.default.$transaction((tx) =>
      __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (
          [client_1.OrderStatus.CANCELED, client_1.OrderStatus.FAILED].includes(
            payload.status,
          )
        ) {
          yield manageUnsuccessfulOrdersIntoDB(
            payload.status,
            payload.orderId,
            tx,
          );
    ...
    yield notification_service_1.default.createNotificationIntoDB(
      Object.assign(
        Object.assign(
          { usersId: [order.customer.userId] },
          (0, function_1.getOrderStatusMessage)(payload.status),
        ),
        { type: "ALERT" },
      ),
    );
...
const cancelMyOrderIntoDB = (authUser, id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    id = Number(id);
    const order = yield prisma_1.default.order.findUnique({
      where: {
...
const getOrdersForManageFromDB = (filter, paginationOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { startDate, endDate, status, customerId, orderId } = filter;
    const { skip, limit, page, sortOrder, orderBy } = (0,
...
const getMyOrdersFromDB = (authUser, filter, paginationOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getMyOrderByIdFromDB = (authUser, id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    id = Number(id);
    const order = yield prisma_1.default.order.findUnique({
      where: {
...
const getOrderByIdForManageFromDB = (id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    id = Number(id);
    const order = yield prisma_1.default.order.findUnique({
      where: {
...
const getNotReviewedOrderItemsFromDB = (authUser, paginationOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { skip, limit, page } = (0, paginationHelper_1.calculatePagination)(
      paginationOptions,
    );
...
const getStockOutProductsFromDB = (paginationOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const whereConditions = {
      OR: [
        {
    ...
    const totalResult = prisma_1.default.product.count({
      where: whereConditions,
    });
    const meta = {
      page,
