...
const updateMyProfileIntoDB = (authUser, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (user.role === client_1.UserRole.CUSTOMER) {
      ...
      result = yield prisma_1.default.$transaction((txClient) =>
        __awaiter(void 0, void 0, void 0, function* () {
          const { addresses } = data,
            othersData = __rest(data, ["addresses"]);
          ...
          if (addresses && addresses.length) {
            const deletedAddresses =
              addresses === null || addresses === void 0
                ? void 0
                : addresses.filter((_) => _.id && _.isDeleted);
            const newAddedAddresses =
              addresses === null || addresses === void 0
                ? void 0
                : addresses.filter((_) => !_.id && !_.isDeleted);
    ...
    // Update administrator
      ...
      const data = payload;
      profile_validation_1.default.UpdateAdministratorProfileValidation.parse(
        data,
      );
