...
const getNotificationsFromDB = (filter, paginationOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getMyNotificationsFromDB = (authUser, paginationOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { skip, limit, page, orderBy, sortOrder } = (0,
    paginationHelper_1.calculatePagination)(paginationOptions);
    const data = yield prisma_1.default.notification.findMany({
...
const notificationsSetAsReadIntoDB = (authUser) =>
  __awaiter(void 0, void 0, void 0, function* () {
