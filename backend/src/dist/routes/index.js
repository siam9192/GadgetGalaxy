...
const payment_route_1 = __importDefault(
  require("../modules/Payment/payment.route"),
);
const cart_item_route_1 = __importDefault(
  require("../modules/CartItem/cart-item.route"),
);
const shipping_charge_route_1 = __importDefault(
  require("../modules/ShippingCharge/shipping-charge.route"),
);
const notification_route_1 = __importDefault(
  require("../modules/Notification/notification.route"),
);
const discount_route_1 = __importDefault(
  require("../modules/Discount/discount.route"),
);
const brand_route_1 = __importDefault(require("../modules/Brand/brand.route"));
const profile_route_1 = __importDefault(
  require("../modules/Profile/profile.route"),
);
const product_review_route_1 = __importDefault(
  require("../modules/ProductReview/product-review.route"),
);
const administratorActivityLog_route_1 = __importDefault(
  require("../modules/AdministratorActivityLog/administratorActivityLog.route"),
);
const overview_route_1 = __importDefault(
  require("../modules/Overview/overview.route"),
);
const wishListItem_route_1 = __importDefault(
  require("../modules/WishListItem/wishListItem.route"),
);
